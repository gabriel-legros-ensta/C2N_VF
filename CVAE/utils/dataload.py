...
def load_normalize_data(batch_size=64, shuffle=True, return_dataset=False):
    ...
    X_data = np.load('C:\\Users\\gabriel.legros\\Documents\\VSCode\\Github\\C2N\\CVAE\\data\\x_data.npy')
    y_data = np.load('C:\\Users\\gabriel.legros\\Documents\\VSCode\\Github\\C2N\\CVAE\\data\\y_data.npy')
    labels_data = np.load('C:\\Users\\gabriel.legros\\Documents\\VSCode\\Github\\C2N\\CVAE\\data\\label_data.npy')
    ...
    dataset = TensorDataset(X_scaled, y_scaled, labels_tensor)
